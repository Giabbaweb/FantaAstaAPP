...
INSERT INTO `__new_auction_events`("id", "auction_session_id", "auction_call_id", "event_type", "auction_session_team_id", "player_id", "amount", "credits_before", "credits_after", "suspension_reason", "created_at") SELECT "id", "auction_session_id", "auction_call_id", "event_type", "auction_session_team_id", "player_id", "amount", "credits_before", "credits_after", NULL, "created_at" FROM `auction_events`;--> statement-breakpoint
