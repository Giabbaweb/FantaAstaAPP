...
INSERT INTO `__new_auction_events`("id", "auction_session_id", "auction_call_id", "event_type", "auction_session_team_id", "player_id", "amount", "credits_before", "credits_after", "contract_year", "actor_name", "actor_role", "comment", "suspension_reason", "created_at") SELECT "id", "auction_session_id", "auction_call_id", "event_type", "auction_session_team_id", "player_id", "amount", "credits_before", "credits_after", NULL, NULL, NULL, NULL, "suspension_reason", "created_at" FROM `auction_events`;--> statement-breakpoint
